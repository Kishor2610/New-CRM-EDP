...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-edit"></i> Edit Quotation</h1>
            </div>
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item">
                    <a href="/"><i class="fa fa-home fa-lg"></i></a>
                </li>
                <li class="breadcrumb-item"><a href="#">Edit Quotation</a></li>
            </ul>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="tile">
                    <h3 class="tile-title">Quotation</h3>
                    <div class="tile-body">
                        <form  method="POST" action="{{route('quotation.update',$quotation->id)}}">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select name="customer_id" class="form-control">
                                    <option name="customer_id" value="{{$quotation->customer->id}}">{{$quotation->customer->name}}</option>
                                ...
                                @foreach($quotation_sales as $quotation_sale)
                                 <tr>
                                    <td><select name="product_id[]" class="form-control productname" >
                                            <option name="product_id[]" value="{{$quotation_sale->product->id}}">{{$quotation_sale->product->name}}</option>
                                            @foreach($products as $product)
                                                <option name="product_id[]" value="{{$product->id}}">{{$product->name}}</option>
                                            @endforeach
                                        </select></td>
                                    <td><input value="{{$quotation_sale->qty}}" type="text" name="qty[]" class="form-control qty" ></td>
                                    <td><input value="{{$quotation_sale->price}}" type="text" name="price[]" class="form-control price" ></td>
                                    {{-- <td><input value="{{$quotation_sale->dis}}" type="text" name="dis[]" class="form-control dis" ></td> --}}
                                    ...
                                    <td><input value="{{$quotation_sale->amount}}" type="text" name="amount[]" class="form-control amount" ></td>
                                    <td>
